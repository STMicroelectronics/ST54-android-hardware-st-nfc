...
typedef enum {
  ...
  HAL_WRAPPER_STATE_OPEN,      /* ABI */
  HAL_WRAPPER_STATE_OPEN_CPLT, /* ABI */
  HAL_WRAPPER_STATE_FETCH_LOGS,
  ...
  HAL_WRAPPER_STATE_CLOSING_FETCH_LOGS,
  HAL_WRAPPER_STATE_EXIT_HIBERNATE_ENTER_LOADER,
  HAL_WRAPPER_STATE_LD_UPDATE,
  HAL_WRAPPER_STATE_UPDATE,
  HAL_WRAPPER_STATE_AUTH,
  HAL_WRAPPER_STATE_APPLY_CUSTOM_PARAM, /* ABI */
  /* New states need to be added below this point,
     above states marked with "ABI" need to keep same value to maintain ABI
     compatibility for libstnfc-auth.so */
  HAL_WRAPPER_STATE_EXIT_HIBERNATE_ONLY,
} hal_wrapper_state_e;
